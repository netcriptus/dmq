...
class MainWindow(QMainWindow):
    ...
    def draw_start_screen(self):
        start_menu = {
            "start_random_button": (
                QPushButton("Start quiz with random substances"),
                "random_quiz",
            ),
            "start_choice_button": (
                QPushButton("Choose substace and start quiz"),
                "choose_quiz",
            ),
            "situation_quiz_button": (
                QPushButton("Start quiz about situations"),
                "situation_quiz",
            ),
            "register_button": (
                QPushButton("Register substance"),
                "draw_register_screen",
            ),
            "register_situation_button": (
                QPushButton("Register situation"),
                "register_situation",
            ),
        }
